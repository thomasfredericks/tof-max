...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 470.0, 45.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "delayr",
					"viewvisibility" : 1
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 712.0, 376.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 698.5, 95.5, 134.0, 66.0 ],
					"text" : "If the movement goes over the threshold, a sample is triggered."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.0, 163.5, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 681.0, 94.0, 22.0 ],
					"text" : "send movement"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 398.75, 154.227272868156433, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 712.0, 432.5, 138.0, 103.5 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-3::obj-48" : [ "pictctrl[2]", "pictctrl[2]", 0 ],
			...
			"snapshot" : 			{
				"valuedictionary" : 				{
					"parameter_values" : 					{
						"delay[1]" : 8.0,
						"device" : 1.0,
						"gain[1]" : -3.000000000000014,
						"mute[1]" : 0.0,
						"play[2]" : 1.0,
						"threshold[1]" : 0.216535433070867,
						"blob" : 						{
							"threshold[2]" : [ 0.1 ]
						}
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"minorversion" : 0,
						"name" : "init",
						"origin" : "video input - movement.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "init",
							"filename" : "init_20230406_2.maxsnap",
							"filepath" : "~/OneDrive/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "6b2dc40c3f4b40bf5bb2eafef2938dd6"
						}
