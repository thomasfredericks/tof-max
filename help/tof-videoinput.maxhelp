...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 389.0, 59.0, 22.0 ],
					"text" : "jit.gl.layer"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 67.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 185.0, 220.727272868156433, 96.5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 128.0, 133.166663438081741, 34.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"name" : "tof-videoinput.maxhelp.maxsnap",
...
,
						"fileref" : 						{
							"name" : "init",
							"filename" : "tof-videoinput.maxhelp.maxsnap",
							"filepath" : "~/OneDrive/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "4723e96d310662ed5f4592967316f1e2"
						}
