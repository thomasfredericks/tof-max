...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 583.0, 514.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
,
					...
					"output_texture" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 508.0, 443.0, 150.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.833336561918259, 238.0, 133.166663438081741, 34.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.833336561918259, 793.0, 59.0, 22.0 ],
					"text" : "jit.gl.layer"
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "tof-texturesynthesizerrgb.maxpat",
					"numinlets" : 4,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 55.833336561918259, 574.0, 295.437390708332941, 169.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 156.0, 303.0, 152.5, 153.030966000000035 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-8::obj-10" : [ "b[1]", "b", 0 ],
			"obj-8::obj-31" : [ "w[2]", "w", 0 ],
			"obj-8::obj-32" : [ "h[2]", "h", 0 ],
			"obj-8::obj-34" : [ "r[1]", "r", 0 ],
			"obj-8::obj-8" : [ "a[1]", "a", 0 ],
			"obj-8::obj-9" : [ "g[1]", "g", 0 ],
			"parameterbanks" : 			{
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"minorversion" : 0,
						"name" : "init",
						"origin" : "tof-texturesynthesizerrgb.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							...
							"filepos" : -1,
							"snapshotfileid" : "7a7e896a3a8a69f97ddc0ae47eb2fe3a"
						}
